  ...
  Company.create(_b)
    .then(async (data) => {
      ...
      for (let course in _b.eligibility) {
        if (course == "UG") {
          email.push(batch - 4 + "_ug_all@daiict.ac.in");
        } else if (course == "MTech") {
          email.push(batch - 2 + "_MTECH@daiict.ac.in");
        } else if (course == "MPlan") {
          email.push(batch - 2 + "_PAR@daiict.ac.in");
        } else if (course == "MSc") {
          email.push(batch - 2 + "_MSC@daiict.ac.in");
        } else if (course == "MBA") {
          email.push(batch - 2 + "_PBM@daiict.ac.in");
        }
      }
